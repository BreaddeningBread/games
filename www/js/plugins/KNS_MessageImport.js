/*:
 * @target MZ
 * @plugindesc [ver.1.0.0(2022/3/23)]Merges .txt files as .json database exported by KNS_MessageExport
...
/*ja:
 * @target MZ
 * @plugindesc [ver.1.0.0(2022/3/23)]KNS_MessageExportで出力し改変したtxtファイルをjsonに戻します。
 * @url https://kanjinokusargss3.hatenablog.com/
 * @author 莞爾の草
 * 
 * @base KNS_MessageExport
	...
	restoreEventList: function(text, json){
		...
		for (let i = 0; i < lines.length; i++){
			...
			if (array102.length > 0){
				...
				list[index].parameters[0] = array102;
				index++;
				i--;
				continue;
			}
